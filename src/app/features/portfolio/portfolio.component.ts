  ...
  myProjects: Project[] = [
    {
      ...
      isInternal: true,
      alert:
        'Onine version of project use mocked data, so some functionalities can not work as expected. To test full functionality please visit the repository and run application locally.',
